		...
		<div className={styles.home}>
			...
			>
				<h2 className={styles['hero-title']}>
					<span className={styles['hero-title-highlight']}>Local Drive</span>{' '}
					easy to store your content
				</h2>
				<p className={styles['hero-content']}>
					Manage file from your mobile device or computer and sharing file to
					anyone.
				</p>
				<a className={styles['home-link']} href="/account/register">
			...
			<div className={styles.container}>
				<div className={styles.introduce}>
					...
					<div className={styles['introduce-content']}>
						...
						<p>
							Even people without an account can easily access your shared files
							or folders.
						</p>
					</div>
				</div>
				<div className={styles.introduce}>
					...
					<div className={styles['introduce-content']}>
						...
						<p>
							When sharing, your&apos;re still in control. You can set expired
							links to limit who can access your files or folders.
						</p>
					</div>
				</div>
